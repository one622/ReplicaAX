...
namespace Sucarcane
{
    public class clsPostges
    {
        ...
        //private static bool IsUserAdExist(string username, string password)
        //{
        //    bool ret = false;
        //    var directoryEntry = new DirectoryEntry("LDAP://tcc.co.th", "tcc\\" + username.ToLower().Replace("tcc\\", ""), password);
        //    try
        //    {
