...
////$.fn.fileExif = function(callback) {//µé¹©ºÑº
//$.fn.fileExif = function (callback, i) {
...
//        callback(EXIF.readFromBinaryFile(binaryResponse),i); //µé¹©ºÑº
//    };
//    //reader.readAsBinaryString(getFilePart(this[0].files[0]));//µé¹©ºÑº  ¿Ñ§¡ìªÑè¹ readAsBinaryString   äÁè«Ñ¾¾Íµº¹ IE
//    reader.readAsBinaryString(getFilePart(this[0].files[i])); // à¿ÃÁá¡éãËÁè äÁèµéÍ§ÃÍcall back
...
$.fileExif = function(file, callback) {
    ...
    reader.readAsBinaryString(getFilePart(file));  //¿Ñ§¡ìªÑè¹ readAsBinaryString   äÁè«Ñ¾¾Íµº¹ IE
};
